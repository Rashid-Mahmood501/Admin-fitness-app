...
export default function CreatedMealPlansList({ mealPlans, onEditPlan, onCreateNew }: CreatedMealPlansListProps) {
  ...
  const getMealTypeCount = (mealPlan: MealPlan, mealType: string) => {
    return mealPlan.days.reduce((count, day) => {
      return count + day.mealOptions.filter(meal => meal.mealType === mealType).length;
    }, 0);
  };
    ...
    <div className="mt-8">
      ...
      {mealPlans?.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h3 className="text-xl font-semibold text-gray-600 mb-2">No meal plans created yet</h3>
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex-1">
                  <h3 className="text-lg font-bold text-[#171616] mb-1">{mealPlan.title}</h3>
              ...
              <div className="mb-4 p-3 bg-gray-50 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{mealPlan.totalCalories}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Protein:</span>
                    <span className="font-medium">{mealPlan.totalProtein}g</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Fat:</span>
                    <span className="font-medium">{mealPlan.totalFat}g</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Carbs:</span>
                    <span className="font-medium">{mealPlan.totalCarbs}g</span>
                  </div>
                </div>
              </div>
              ...
              {/* Meal Type Breakdown */}
              <div className="mb-4">
                <h4 className="text-sm font-semibold text-gray-700 mb-2">Meal Breakdown</h4>
